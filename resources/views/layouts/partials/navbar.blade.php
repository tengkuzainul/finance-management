    ...
    <div class="h-full px-4 md:px-6 flex items-center justify-between">
        ...
        <div class="flex items-center gap-4">
            ...
            <div class="hidden md:flex items-center">
                <div class="relative">
                    <input type="text" placeholder="Cari transaksi, laporan..."
        ...
        <div class="flex items-center gap-2 md:gap-4">
            ...
            <button class="md:hidden p-2 rounded-lg hover:bg-slate-100 text-slate-600">
            ...
            <!-- Quick Add Button -->
            <button
                class="hidden md:flex items-center gap-2 px-4 py-2 bg-linear-to-r from-orange-500 to-orange-600 text-white text-sm font-medium rounded-xl hover:from-orange-600 hover:to-orange-700 shadow-lg shadow-orange-500/30 transition-all duration-200">
