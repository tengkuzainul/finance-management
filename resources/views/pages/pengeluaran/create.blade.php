...
@section('page-header')
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-2xl md:text-3xl font-bold text-slate-800">Tambah Pengeluaran</h1>
            <p class="text-slate-500 mt-1">Catat transaksi pengeluaran baru</p>
        </div>
    </div>
@endsection
    ...
    <div class="max-w-3xl">
        <form action="#" method="POST" class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
            ...
            <div class="p-6 md:p-8 space-y-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="date" id="tanggal" name="tanggal" value="{{ date('Y-m-d') }}"
                                class="w-full pl-12 pr-4 py-3 bg-slate-100 border-0 rounded-xl text-slate-700 focus:outline-none focus:ring-2 focus:ring-red-500/20 focus:bg-white transition-all duration-200"
                                required>
                ...
                <div>
                    ...
                    <div class="relative">
                        <select id="kategori" name="kategori_id"
                            class="w-full pl-12 pr-4 py-3 bg-slate-100 border-0 rounded-xl text-slate-700 focus:outline-none focus:ring-2 focus:ring-red-500/20 focus:bg-white transition-all duration-200 appearance-none"
                            required>
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="text" id="deskripsi" name="deskripsi"
                            placeholder="Contoh: Pembelian Daging Sapi 5 kg"
                            class="w-full pl-12 pr-4 py-3 bg-slate-100 border-0 rounded-xl text-slate-700 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-red-500/20 focus:bg-white transition-all duration-200"
                            required>
                        <div class="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400">
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="text" id="jumlah" name="jumlah" placeholder="0"
                            class="w-full pl-20 pr-4 py-3 bg-slate-100 border-0 rounded-xl text-slate-700 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-red-500/20 focus:bg-white transition-all duration-200 text-right text-xl font-semibold"
                            required>
                        <div class="absolute left-4 top-1/2 -translate-y-1/2 text-slate-500 font-medium">
                            Rp
                        </div>
                    </div>
                    <p class="mt-2 text-sm text-slate-500">Masukkan jumlah pengeluaran tanpa titik atau koma</p>
                </div>
                ...
                <div>
                    ...
                    <textarea id="catatan" name="catatan" rows="3" placeholder="Tambahkan catatan tambahan jika diperlukan..."
                        class="w-full px-4 py-3 bg-slate-100 border-0 rounded-xl text-slate-700 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-red-500/20 focus:bg-white transition-all duration-200 resize-none"></textarea>
                </div>
                ...
                <div>
                    ...
                    <div
                        class="border-2 border-dashed border-slate-200 rounded-xl p-8 text-center hover:border-red-500 hover:bg-red-50/30 transition-all duration-200 cursor-pointer">
            ...
            <div class="px-6 md:px-8 py-4 bg-slate-50 border-t border-slate-100 flex items-center justify-end gap-3">
                ...
                <button type="submit"
                    class="px-6 py-2.5 bg-gradient-to-r from-red-500 to-red-600 text-white text-sm font-medium rounded-xl hover:from-red-600 hover:to-red-700 shadow-lg shadow-red-500/30 transition-all duration-200 flex items-center gap-2">
