    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                ...
                <p class="text-gray-600 mt-1">Laporan transaksi harian semua cabang</p>
            </div>
            <div class="flex items-center gap-2">
                <a href="{{ route('master-data.laporan-keuangan.export-pdf', ['tanggal_mulai' => $tanggal, 'tanggal_akhir' => $tanggal]) }}"
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
            <form action="{{ route('laporan.harian') }}" method="GET" class="flex flex-col sm:flex-row gap-4">
