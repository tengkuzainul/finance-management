    ...
    <div class="space-y-6">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-gray-600 mt-1">Tambahkan data cabang/lokasi baru</p>
            </div>
        </div>
            ...
            <form id="formCabang" class="p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="kode_cabang" id="kode_cabang" value="{{ $kodeCabang }}"
                ...
                <div>
                    ...
                    <textarea name="alamat_lengkap" id="alamat_lengkap" rows="3"
                        ...
                        placeholder="Masukkan alamat lengkap cabang..." required></textarea>
                </div>
...
@push('scripts')
    <script>
        document.getElementById('formCabang').addEventListener('submit', function(e) {
            ...
            fetch('{{ route('master-data.cabang.store') }}', {
                    method: 'POST',
                    headers: {
                ...
                .catch(error => {
                    ...
                    if (error.response && error.response.status === 422) {
                        error.response.json().then(data => {
                            ...
                            SwalHelper.error('Validasi Gagal!', errorMessage);
                        });
                    } else {
